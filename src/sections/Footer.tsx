      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-6 md:flex-row lg:px-12">
        <div className="flex flex-col items-center gap-2 md:items-start">
          <Link href="/" className="flex items-center gap-2" aria-label="Go to homepage">
            ...
            <span className="font-[family-name:var(--font-space-grotesk)] text-sm font-semibold text-text-primary">
              Mash Partners
            </span>
          </Link>
        ...
        <div className="flex items-center gap-4">
          {socials.map((social) => (
            <motion.a
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full border border-white/5 text-text-muted transition-all duration-300 hover:border-accent-violet/30 hover:text-accent-violet hover:shadow-[0_0_15px_rgba(123,97,255,0.15)]"
        ...
        <span className="text-xs text-text-muted">
          &copy; {new Date().getFullYear()} Mash Partners. All rights reserved.
        </span>
      </div>
    </footer>
  );
